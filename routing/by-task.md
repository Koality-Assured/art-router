...
| **Artistic asset brief or representation review** | `docs/standards/` | [`router`](../ai-tooling/agents/router/AGENT.md) | [`artistic-practice.md`](../docs/standards/artistic-practice.md) + [`artistic-representations.md`](../docs/standards/artistic-representations.md) | Review intent, context, medium gates, accessibility, rights, safety, provenance, and handoff |
